...
export function FacilitySettings() {
  ...
  const handleSuspendAccount = () => {
    localStorage.setItem('facilityAccountSuspended', 'true');
          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full shadow-2xl">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-red-800 mb-3">
                <strong>Warning:</strong> This will permanently delete your facility account including:
              </p>
              <ul className="text-sm text-red-700 space-y-1 ml-4 list-disc">
                <li>All facility profile information</li>
                <li>Appointment history and records</li>
                <li>Insurance and payer configurations</li>
