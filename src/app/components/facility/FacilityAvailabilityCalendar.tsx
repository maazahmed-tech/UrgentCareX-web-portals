    ...
    <DashboardLayout title="Availability Calendar" role="facility">
      <div className="max-w-6xl">
        ...
        <div className="mb-4 md:mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <p className="text-sm md:text-base text-gray-600">Set your facility's weekly availability schedule</p>
                ...
                <div className="p-4 md:p-5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                    <div className="flex items-center gap-3 md:gap-4">
                      ...
                      {!daySchedule.enabled && (
                        <span className="text-xs md:text-sm text-gray-500">Closed</span>
                      )}
                      {daySchedule.enabled && (
