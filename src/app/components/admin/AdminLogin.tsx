...
export function AdminLogin() {
  ...
  useEffect(() => {
    console.log('📍 Current Screen: Admin Login');
  }, []);
  ...
  const fillDemoCredentials = () => {
    setEmail('admin@urgentcarex.com');
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  <p><span className="font-medium">Email:</span> admin@urgentcarex.com</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="admin@urgentcarex.com"
                required
                className="mt-1"
              />
            </div>
